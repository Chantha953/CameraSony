      ...
      >
        ...
        <div className="mt-4 position-relative">
          ...
          <i onClick={()=>setShowPassword(!showPassword)}
            class={`${showPassword?"fa-solid fa-eye":"fa-solid fa-eye-slash"} position-absolute fs-5`}
        ...
        <div className="mt-4 position-relative">
          ...
          <i onClick={()=>setShowConfirmPassword(!showConfirmPassword)}
            class={`${showConfirmPassword?"fa-solid fa-eye":"fa-solid fa-eye-slash"} position-absolute fs-5`}
            style={{ top: "13px", right: "20px" , cursor : "pointer"}}
          ></i>
        </div>
